              ...
              <div className={`col-md-5 ${idx % 2 === 0 ? 'text-end' : 'text-start'}`}>
                ...
                >
                  ...
                  <div style={{ height: '180px', overflow: 'hidden', position: 'relative' }}>
                    ...
                    <img src={`${API}/uploads/achievement/${item.photo}`} className="w-100 h-100" style={{ objectFit: 'cover' }} />
          ...
          >
            ...
            >
              <div className="position-relative">
                <img src={`${API}/uploads/achievement/${selectedItem.photo}`} className="w-100" style={{ height: '300px', objectFit: 'cover' }} />
